    ...
    def select_unassigned_variable(self, assignment):
        ...
        for var in self.crossword.variables:
            if var not in set(assignment):
                if (
                    bvalue is None or len(self.crossword.neighbors(var)) > len(self.crossword.neighbors(bvalue))or
                    len(self.domains[var]) < len(self.domains[bvalue]) ):
                    bvalue = var
